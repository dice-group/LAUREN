...
def read_QALD8():
    data = json.load(io.open('datasets/qald-8-test-multilingual.json', encoding='utf-8'))
    questions=[[question['question'][0]['string'],question['query']['sparql'],extract_relation_QALD7(question['query']['sparql']),extract_entities_QALD7(question['query']['sparql'])] for question in data['questions']]
    return questions

def read_QALD9():
    data = json.load(io.open('datasets/qald-9-test-multilingual.json', encoding='utf-8'))
    questions=[[question['question'][4]['string'],question['query']['sparql'],extract_relation_QALD7(question['query']['sparql']),extract_entities_QALD7(question['query']['sparql'])] for question in data['questions']]
    return questions
