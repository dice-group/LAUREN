package eu.wdaqua.qanary.dice_kgsum;
 ...
 */
public class NEDAgdistis extends QanaryComponent {
	private final String agdistisService = "http://127.0.0.1:8181/AGDISTIS";
	private static final Logger logger = LoggerFactory.getLogger(NEDAgdistis.class);
